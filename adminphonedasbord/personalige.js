const pErsonnalige = () => {
    (async function ($) {
        ...
        if (annoncePers && annoncePers.length > 0) {
            ...
            $("#phonea").css("background-image", `url(${annoncePers.find(item => item.which === "slidea") ? annoncePers.find(item => item.which === "slidea").image : "../assets/img/error-404.png"})`);
            $("#phoneb").css("background-image", `url(${annoncePers.find(item => item.which === "slideb") ? annoncePers.find(item => item.which === "slideb").image : "../assets/img/error-404.png"})`);
            $("#phonec").css("background-image", `url(${annoncePers.find(item => item.which === "slidec") ? annoncePers.find(item => item.which === "slidec").image : "../assets/img/error-404.png"})`);
            document.getElementById('phoneaid').value = `${annoncePers.find(item => item.which === "slidea") ? annoncePers.find(item => item.which === "slidea")._id : "huhed9683e"}`;
            document.getElementById('phonebid').value = `${annoncePers.find(item => item.which === "slideb") ? annoncePers.find(item => item.which === "slideb")._id : "huhed9683e"}`;
            document.getElementById('phonecid').value = `${annoncePers.find(item => item.which === "slidec") ? annoncePers.find(item => item.which === "slidec")._id : "huhed9683e"}`;
