              ...
              <div class="col-xl-6 pl-xl-2">
                <div class="row">
                  ...
                  <div class="col-sm-6 pl-sm-2 statistics-grid">
                    ...
                    <i class="lnr store">
                        <img src="../adminpcdasborad/assets/img/creditecard.png" alt="store4" width="50" height="50">
                    </i> 
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 pl-sm-2 statistics-grid">
                   ...
                   >
                    ...
                    <i class="lnr store">
                    <img src="../adminpcdasborad/assets/img/phonea.png" alt="store5" width="50" height="70">
                </i>
    ...
    if (order && order.length > 0) {
      ...
      if (odernotnu > 0) {
        ...
        notification_header.innerHTML = `
            ...
            <li>
                <a href="#" class="grid">
                    <div class="user_img"><img src="../adminpcdasborad/assets/img/avatay.png" alt=""></div>
